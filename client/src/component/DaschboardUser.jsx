    ...
    <div>
      ...
      <div className="show_posts">
        {filteredPosts.map((post) => {
          return (
            <div className="post" key={post._id} style={{ boxShadow: '10px 10px 5px lightblue', marginBottom: '40px',marginLeft:"5%", border: '0.5px solid',width:"90%", height: '300px',borderRadius:'5px' }}>
              <>
